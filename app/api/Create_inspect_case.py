        ...
        with conn.cursor() as cursor:
          ...
          cursor.execute('''
            INSERT INTO hillside_inspect (
              案由, 時間, 會勘單位與人員, 土地基本資料, 行為人基本資料, 違規類別, 輔導類別, 各單位意見, 行為人意見, 會勘結論, 現場照片, 散會, 修改時間, 建立時間
            ) VALUES (
              %(案由)s, %(時間)s, %(會勘單位與人員)s, %(土地基本資料)s, %(行為人基本資料)s, %(違規類別)s, %(輔導類別)s, %(各單位意見)s, %(行為人意見)s, %(會勘結論)s, %(現場照片)s, %(散會)s, %(修改時間)s, %(建立時間)s
            )
          ''', {
            '案由': data['案由'],
            '時間': data['時間'],
