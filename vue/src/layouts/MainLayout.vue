<template >
  <q-list class="lg:(px-12) md:(px-2)" bordered>
    ...
    <q-expansion-item class='text-lg text-bold' expand-separator icon='supervisor_account' label='會勘單位與人員'>
      <q-card>
        <q-card-section>
          <q-item v-for='_attendees, n of attendees' :key='n'>
            ...
            <q-item-section>
              <q-select v-show="(_attendees.type === 'select')" v-model='inspectRecord[_attendees.name]' :options='_attendees.data' :label=_attendees.label filled dense />
              <q-input v-show="(_attendees.type === 'input')" v-model='inspectRecord[_attendees.name]' :label=_attendees.label filled dense />
            </q-item-section>
            <q-item-section side>
              <q-btn icon='edit' color='grey-3' class='text-grey-7' @click='isShowDialog.district = true' dense />
    ...
    <q-expansion-item class='text-lg text-bold' expand-separator icon='place' label='土地基本資料'>
      <q-card>
        <q-card-section>
      <q-item>
    ...
    <q-expansion-item class='text-lg text-bold' expand-separator icon='perm_identity' label='行為人基本資料'>
      <q-card>
        <q-card-section>
