export const attendees = [
  ...
  { name: '本府局處', type: 'select', label: '請選擇本府局處', data: ['無', '秘書處', '民政局', '財政局', '教育局', '經濟發展局', '工務局', '水利局', '農業局', '城鄉發展局', '社會局', '地政局', '勞工局', '交通局', '觀光旅遊局', '法制局', '警察局', '衛生局', '環境保護局', '消防局', '文化局', '原住民族行政局', '新聞局', '人事處', '主計處', '政風處', '研究發展考核委員會', '客家事務局', '捷運工程局', '青年局'] },
